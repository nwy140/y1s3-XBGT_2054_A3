...
// Ref: https://answers.unity.com/questions/518399/simulate-child-parent-relationship.html
// Ref: https://answers.unity.com/questions/1614883/moving-objects-together-without-parenting.html
public class TransformAutoFakeParent : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        startChildPosition =
            DivideVectors(Quaternion.Inverse(parentTransform.rotation) * (startChildPosition - startParentPosition),
                startParentScale);
    }
    ...
    void Update()
    {
        ...
        transform.rotation =
            (parentTransform.rotation * Quaternion.Inverse(startParentRotationQ)) * startChildRotationQ;
        ...
        if (attemptChildScale)
        {
            transform.localScale =
                Vector3.Scale(startChildScale, DivideVectors(parentTransform.lossyScale, startParentScale));
        }
