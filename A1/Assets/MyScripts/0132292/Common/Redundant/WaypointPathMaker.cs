...
// The CinemachinePath Component from the Unity samples is much better than my own Pathmaker/Splnelike Script
// So Please use that instead
public class WaypointPathMaker : MonoBehaviour
{
    public bool loop;
