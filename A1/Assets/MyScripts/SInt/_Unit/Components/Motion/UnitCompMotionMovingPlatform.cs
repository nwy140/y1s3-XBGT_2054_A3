...
// Ref: https://sharpcoderblog.com/blog/unity-3d-character-controller-moving-platform-support
public class UnitCompMotionMovingPlatform : MonoBehaviour
{
    ...
    {
        if (ignoredLayerMask != (ignoredLayerMask | (1 << hit.gameObject.layer))) // if hit not in ignored Layermask
        {
